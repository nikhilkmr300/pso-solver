...
pso_solver.psoVisualize(particleList, f, xlower, xupper, ylower, yupper, c1=1, c2=1, W=0.5, numIters=25, maxFlag=False, sleepTime=0.1, density=100, accuracy=2, verbose=False)
